...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "Контуры";
	ВидДоступа.Представление = НСтр("ru = 'Контуры'");
	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.Контуры");
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Справочники.ИнформационныеБазы1С, Истина);
	Списки.Вставить(Метаданные.Справочники.Проекты, Истина);
	Списки.Вставить(Метаданные.Справочники.Контуры, Истина);
	Списки.Вставить(Метаданные.Справочники.СпискиИнформационныхБаз, Истина);
	//Списки.Вставить(Метаданные.Справочники.СерверыБазДанных, Истина);
	//Списки.Вставить(Метаданные.Справочники.СерверыПриложений1С, Истина);
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт	
	...
	// Профиль "Участник проекта".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Идентификатор = "263d8435-6937-11ef-baa6-18c04df685f3";
	ОписаниеПрофиля.Наименование  =
		НСтр("ru = 'Участник проекта'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Основной профиль для указания списка участников проекта'");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваУБ1С");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеИнформационныхБаз1С");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеСписковИнформационныхБаз");
	ОписаниеПрофиля.Роли.Добавить("ИзменениеПараметровИБНаСервереПриложений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеВерсийПлатформы1С");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеМенеджераПаролей");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПользователей");
	...
	ОписаниеПрофиля.ВидыДоступа.Добавить("Контуры", "ВначалеВсеРазрешены");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);

	// Профиль "Архитектор проекта".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "АрхитекторПроекта";
	ОписаниеПрофиля.Идентификатор = "75fa0ecb-98bb-11df-b54f-e0cb4ed5f656";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Архитектор проекта'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваУБ1С");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеИнформационныхБаз1С");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеСписковИнформационныхБаз");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеКонтуров");
	ОписаниеПрофиля.Роли.Добавить("ИзменениеПараметровИБНаСервереПриложений");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеВерсийПлатформы1С");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеМенеджераПаролей");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеПользователей");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеИзменениеПроектов");
	ОписаниеПрофиля.Роли.Добавить("УправлениеЗащищеннымиКонтурами");
	ОписаниеПрофиля.ВидыДоступа.Добавить("Проекты");
	ОписаниеПрофиля.ВидыДоступа.Добавить("Пользователи");
	ОписаниеПрофиля.ВидыДоступа.Добавить("Контуры", "ВначалеВсеРазрешены");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	// Профиль "Управление глобальными списками баз".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "УправлениеГлобальнымиСпискамиБаз";
	ОписаниеПрофиля.Идентификатор = "75fa0ecb-98aa-11df-b54f-e0cb4ed5f659";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Управление глобальными списками баз'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("УправлениеГлобальнымиСпискамиБаз");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
