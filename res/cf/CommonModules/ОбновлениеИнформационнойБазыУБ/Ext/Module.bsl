...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "УправлениеБазами1С";
	Описание.Версия = "1.0.5.8";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура           = "Справочники.Контуры.ПодготовитьПредопределенныеЭлементы";
	Обработчик.РежимВыполнения     = "Оперативно";
	
	// Заполнение порта адреса администрирования
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "1.0.3.1";
	Обработчик.Процедура           = "Справочники.СерверыПриложений1С.ЗаполнитьПортСервераАдминистрирования";
	Обработчик.РежимВыполнения     = "Оперативно";
