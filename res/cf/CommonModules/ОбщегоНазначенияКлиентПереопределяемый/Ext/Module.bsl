...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	Параметры.Модули.Добавить(ОбновлениеИнформационнойБазыУБКлиент);
...
Процедура ПриУстановкеЗаголовкаКлиентскогоПриложения(ЗаголовокПриложения, ПриЗапуске) Экспорт
	...
	ЗаголовокПриложения = ЗаголовокПриложения + ОбщегоНазначенияКВАВызовСервера.ПолучитьЗаголовокСистемы();
